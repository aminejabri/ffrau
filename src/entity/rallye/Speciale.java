...
public class Speciale {
	...
	//pour r�cup�rer infos concernant une speciale
	...
	//pour modifier infos concernant une rallye --> UML Mise � jour edition rallye
	...
	//r�cup�rer les d�clarations par un coureur � une sp�ciale
